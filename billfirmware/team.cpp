...
namespace team {
    team_t r = { 'R', 0, 0xef301c9a, { 40, 0, 0 }, { 255, 0, 0 } };
    team_t y = { 'Y', 1, 0x8187745d, { 50, 25, 0 }, { 240, 70, 0 } };
    team_t g = { 'G', 2, 0xcad2655e, { 0, 35, 0 }, { 0, 170, 0 } };
    team_t c = { 'C', 3, 0x4ad7d0a9, { 0, 15, 60 }, { 0, 100, 130 } };
    team_t b = { 'B', 4, 0x7da81da1, { 0, 0, 40 }, { 0, 0, 255 } };
    team_t p = { 'P', 5, 0x6c45e2dd, { 50, 0, 15 }, { 255, 0, 150 } };

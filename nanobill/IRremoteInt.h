...
#endif /* if defined(CORE_LED0_PIN) */
...
#else  /* if defined(CORE_OC2B_PIN) */
#define TIMER_PWM_PIN  3             // Arduino Duemilanove, Diecimila, LilyPad, etc
#endif /* if defined(CORE_OC2B_PIN) */
...
#else  /* if defined(CORE_OC1A_PIN) */
#define TIMER_PWM_PIN  9 // Arduino Duemilanove, Diecimila, LilyPad, etc
#endif /* if defined(CORE_OC1A_PIN) */
...
#else  /* if defined(CORE_OC3A_PIN) */
#error "Please add OC3A pin number here\n"
#endif /* if defined(CORE_OC3A_PIN) */
...
#else  /* if defined(CORE_OC4A_PIN) */
#error "Please add OC4A pin number here\n"
#endif /* if defined(CORE_OC4A_PIN) */
...
#else  /* if defined(CORE_OC5A_PIN) */
#error "Please add OC5A pin number here\n"
#endif /* if defined(CORE_OC5A_PIN) */
